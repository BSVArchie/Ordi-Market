...
import { OrdinalsMarket } from '../src/contracts/ordinalsMarket'
...
async function main() {
    await OrdinalsMarket.loadArtifact()
    ...
    const instance = new OrdinalsMarket(
    ...
    console.log('OrdinalsMarket contract was successfully deployed!')
